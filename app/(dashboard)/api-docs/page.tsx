...
const PUBLIC_API_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    endpoints: [
      { method: "GET", path: "/generate-addendum/:vin/:theme", description: "Embed widget HTML: pricing block + download button. Optional ?feature=pricing|button|both&stock=&text=&dealer= (dealer = your inventory dealer ID — scopes the VIN lookup when the same VIN exists under two dealers and selects your button styling; unknown value returns an empty body)", role: "public (widget)" },
      { method: "GET", path: "/generate-button/:vin/:theme",   description: "Embed widget HTML: download button only. Optional ?text=&dealer= (dealer = your inventory dealer ID — selects your button label/styling directly; unknown value returns an empty body)", role: "public (widget)" },
