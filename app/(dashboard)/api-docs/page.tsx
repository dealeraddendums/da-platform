...
const PUBLIC_API_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    endpoints: [
      { method: "GET", path: "/generate-addendum/:vin/:theme", description: "Embed widget HTML: pricing block + download button. Optional ?feature=pricing|button|both&stock=&text=", role: "public (widget)" },
      { method: "GET", path: "/generate-button/:vin/:theme",   description: "Embed widget HTML: download button only. Optional ?text=", role: "public (widget)" },
