...
export default async function OptionsPage() {
  ...
  const profile = await resolveSessionProfile<{ role: string; dealer_id: string | null; active_dealer_id: string | null }>(admin, session, "role, dealer_id, active_dealer_id");
